...
\elias{However, Scudo is built with such security issues in mind, therefore the use of pointers in
the same memory regions as the chunks with data is avoided as much as possible. Therefore,
}
\philipp{I think you can move this to the next chapter (a new first section), 
where you point out what's special about scudo}
